...
func _on_ItemList_item_selected(index):
	...
	var desc = "Craft: " + WorldData.Methods[t][m].Name + "\n" + "Quality: " + str(int(WorldData.Methods[t][m].Quality)) + "/100 | Risk: " + str(int(WorldData.Methods[t][m].Risk)) + "/100\n"
	if WorldData.Methods[t][m].Available == true:
		desc += "Cost: €" + str(int(WorldData.Methods[t][m].Cost)) + ",000 weekly\n"
		desc += "Officers involved: " + str(int(WorldData.Methods[t][m].OfficersRequired)) + "\n"
		var intelDesc = "none"
		...
		# special case: future
			...
			desc += "\nOfficers involved: " + str(int(WorldData.Methods[t][m].OfficersRequired))
