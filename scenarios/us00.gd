...
func GenerateWorld():
	...
	var PA = 4
	WorldData.Organizations.append(
		WorldData.aNewOrganization({ "Type": WorldData.OrgType.MOVEMENT, "Name": "Taliban", "Fixed": false, "Known": true, "Staff": 45000, "Budget": 0, "Counterintelligence": 0, "Aggression": 70, "Countries": [AF,YE,IR,PA], "IntelValue": 0, "TargetConsistency": 0, "TargetCountries": [], })
	)
	var taliban = len(WorldData.Organizations)-1
	# terror
	WorldData.Organizations.append(
		WorldData.aNewOrganization({ "Type": WorldData.OrgType.GENERALTERROR, "Name": "Al-Qaeda", "Fixed": false, "Known": true, "Staff": 2500, "Budget": 10000, "Counterintelligence": 80, "Aggression": 95, "Countries": [AF], "IntelValue": 0, "TargetConsistency": 80, "TargetCountries": [0,AF,YE,IR,PA], })
	)
	...
	WorldData.Organizations.append(
		WorldData.aNewOrganization({ "Type": WorldData.OrgType.GENERALTERROR, "Name": "Haqqani Network", "Fixed": false, "Known": true, "Staff": 4000, "Budget": 100, "Counterintelligence": 60, "Aggression": 60, "Countries": [AF,PA], "IntelValue": 0, "TargetConsistency": 80, "TargetCountries": [0,AF,YE,IR], })
	)
	var haqqani = len(WorldData.Organizations)-1
	WorldData.Organizations[-1].ConnectedTo.append(taliban)
	WorldData.Organizations[taliban].ConnectedTo.append(len(WorldData.Organizations)-1)
	WorldData.Organizations.append(
		WorldData.aNewOrganization({ "Type": WorldData.OrgType.ARMTRADER, "Name": "Arms Black Market", "Fixed": false, "Known": true, "Staff": 1000, "Budget": 10000, "Counterintelligence": 65, "Aggression": 80, "Countries": [AF,YE,IR], "IntelValue": 0, "TargetConsistency": 0, "TargetCountries": [], })
	)
...
func ModifyMethods():
	WorldData.Methods[0].remove(13)
	WorldData.Methods[0].remove(9)
	WorldData.Methods[0].remove(7)
	WorldData.Methods[0].remove(6)
	WorldData.Methods[0].remove(5)
	WorldData.Methods[0].remove(0)
	WorldData.Methods[2].remove(16)
	WorldData.Methods[2].remove(13)
	WorldData.Methods[2].remove(10)
	WorldData.Methods[2].remove(7)
	WorldData.Methods[2].remove(5)
